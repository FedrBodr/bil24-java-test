...
**Статус:** одобрен владельцем 16.09.2026; задачи 1–3 выполнены, идёт финальная проверка. Зависимость: [план парсера](2026-09-15-seat-parser.md) предоставляет Maven reactor, профиль comparison и benchmarks jar. Этот план добавляет второй основной модуль и сохраняет результаты парсера.
